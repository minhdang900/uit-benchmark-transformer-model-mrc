...
\begin{enumerate}
  ...
  \item \textbf{Kiểm định bộ stress-test của chính nhóm} trước khi dùng nó. Kết quả là một
        phát hiện âm tính quan trọng: chỉ \AuditAnsInCtx{}/\AuditAns{} câu có đáp án chứa đáp
        án trong ngữ cảnh; nguyên nhân được truy tới hai hàm cụ thể trong mã sinh dữ liệu. Bộ
        này vì vậy \emph{không} được dùng để xếp hạng mô hình (Mục~\ref{sec:audit}).
