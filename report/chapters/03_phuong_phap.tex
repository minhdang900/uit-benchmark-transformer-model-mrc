...
$\tau$ nào được chọn trên nó. Kết quả kiểm định ở Mục~\ref{sec:audit}; điểm của các hệ thống ở
Mục~\ref{sec:res-rq3}.
...
nào chưa có sẽ hiện chữ đỏ ``??'' trong PDF thay vì một con số đoán. Mã nguồn có 348 kiểm thử
