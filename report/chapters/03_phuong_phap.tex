...
(Bảng~\ref{tab:hparams}); chỉ các tham số buộc phải khác do kiến trúc được thay đổi. PhoBERT
chỉ có 256 vị trí hữu dụng nên \code{max\_length} = 256 thay vì 384; phần chồng lấp giữa hai
cửa sổ được giảm tương ứng. Độ dài đáp án tối đa được đặt 64 token cho cả hai, lớn hơn phân vị
...
Chọn epoch & EM trên dev (500 câu ngẫu nhiên) & EM trên dev (500 câu ngẫu nhiên) \\
Ngưỡng không trả lời $\tau$ & 0 & 0 \\
Seed & 42 & 42 \\
\bottomrule
\end{tabular}
\par\vspace{2pt}
...
nào chưa có sẽ hiện chữ đỏ ``??'' trong PDF thay vì một con số đoán. Mã nguồn có 218 kiểm thử
