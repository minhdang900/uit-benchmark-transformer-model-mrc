...
\begin{enumerate}
  ...
  \item \textbf{Câu gốc đi kèm để so theo cặp.} Các nhóm perturbation mang theo chính câu trước
        ...
        nghĩa}. E3b vì thế được đọc theo cặp: trong số cặp mà mô hình trả lời đúng câu gốc, bao
        nhiêu cặp nó \emph{không} từ chối khi câu chứa đáp án đã bị xoá (tỉ lệ hỏng,
        Mục~\ref{sec:audit-method}). ``Luôn từ chối'' không trả lời đúng câu gốc nào, nên chỉ số
        này không xác định cho nó --- nó không thể ``thắng'' nhóm E3 bằng cách không làm gì.
