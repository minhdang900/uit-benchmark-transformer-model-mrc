...
\begin{enumerate}
  \item \textbf{RQ1 --- ranh giới từ.} Giả thuyết ghi trước (PhoBERT yếu hơn vì lỗi tách từ) \emph{sai}
        ở dạng tổng quát: trên những câu có đáp án mà cả hai cùng trả lời, PhoBERT hơn XLM-R \BothGap{} điểm EM,
        và tỉ lệ lỗi biên
  ...
  \item \textbf{RQ3 --- câu không có đáp án.} Ở $\tau = 0$, XLM-R từ chối đúng tần suất nhưng sai đối tượng
        (precision \XlmrAbsPrec\%), còn PhoBERT gần như không từ chối (\PhobertAbsRate\%). Phía PhoBERT, nguyên
        nhân là một sự kiện bất ổn khi fine-tune ở tốc độ học cao --- tái hiện được từ checkpoint epoch 1, đi
        kèm chuẩn gradient vọt lên, và không xảy ra ở tốc độ học $10^{-5}$ --- làm điểm ``không có đáp án'' dịch
        xuống chứ không xoá khả năng phân biệt: ngưỡng chọn trên dev khôi phục nó. Dù vậy, cả hai mô hình
        thường trả về đúng cụm gây nhiễu mà người gán nhãn đặt vào câu hỏi.
...
\paragraph{Điều rút ra.} Ở ngưỡng mặc định, PhoBERT và XLM-R trông như ``bằng nhau với hai hồ sơ kỹ năng
ngược nhau''. Kết luận đó sai: nó là hệ quả của việc so hai mô hình ở hai điểm làm việc khác nhau. Khi mỗi
mô hình dùng ngưỡng chọn trên dev, PhoBERT tốt hơn \PairTDiff{} điểm EM trên cả hai loại câu; trên những câu
cả hai cùng trả lời, khoảng cách ``đọc'' thuần chỉ khoảng \BothGap{} điểm. Bài học phương pháp: với bài toán
có câu không có đáp án, so sánh ở $\tau$ cố định là so sánh hiệu chỉnh, không phải năng lực. Với
...
\begin{enumerate}
  ...
  \item \textbf{Cấu hình cửa sổ khác nhau.} 256 token là ràng buộc của PhoBERT; 384 token cho XLM-R là lựa
        chọn. Lần chạy XLM-R ở 256/96 (Mục~\ref{sec:seeds}) đo ảnh hưởng của lựa chọn này.
  \item \textbf{Nguyên nhân sụp đổ chỉ được xác định đến mức ``đủ để khắc phục''.} Bằng chứng ủng hộ bất ổn
        tối ưu hoá, nhưng vì sao nó chỉ xảy ra với PhoBERT, và liệu có xảy ra trên GPU CUDA hay không, chưa
        được kiểm tra.
