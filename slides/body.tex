...
vi phạm trên \StressN{} mục --- \emph{mọi} mục đều chấm được

\vspace{0.4em}
\footnotesize
$\bullet$ \StressN{} mục trên \StressCtx{} ngữ cảnh\\
$\bullet$ Câu hỏi + đáp án vàng đều do \emph{người} gán (ViQuAD 2.0)\\
$\bullet$ Biến đổi chỉ dùng luật mà nhãn mới suy ra được\\
$\bullet$ ``Luôn từ chối'' chỉ đạt \textbf{\AbstainStressEM} điểm\\[4pt]
\textbf{Kiểm bằng máy:} offset đúng, đáp án đã mất thật sự, câu hỏi E5 hết dấu, không trùng train.
...
\end{column}
\begin{column}{0.46\textwidth}
\small \textbf{EM trên stress-test v2 (\StressN{} mục)}\\[3pt]
\begin{tabular}{@{}l r@{}}
\toprule
...
\vspace{0.5em}
\alert{Mô hình vượt xa mức sàn} --- ``luôn từ chối'' \AbstainStressEM{} điểm. Nhóm lệch từ vựng (E4) và câu hỏi không dấu (E5) là hai chỗ sụt rõ nhất.
\end{column}
\end{columns}
\end{frame}
